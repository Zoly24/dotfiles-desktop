...
if [ -z "$1" ]; then
    ...
    swww img --transition-type wave --transition-duration 1.5 --transition-wave 100,100 --transition-fps 240 --transition-angle 30 --transition-step 200 "$WALLPAPER_PATH"
